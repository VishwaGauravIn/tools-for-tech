        ...
        <div className="offcanvas-body">
            <center>
                ...
                <div className="about-socials">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-github about-social" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-twitter bi-twitter1 about-social" viewBox="0 0 16 16">
                ...
                <hr/>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-laptop" viewBox="0 1 16 16">
