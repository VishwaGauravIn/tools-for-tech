...
export default function ContentTwitter(params) {
    return(
        ...
        <div className="big-box grid2">
                <Card color="bg-gradient-1" title="BlackMagic.so" description="It is a Twitter growth tool using forbidden magic and Twitter API. Create dynamic banners, profile pic and many more." urlLink="https://blackmagic.so/" logo="https://blackmagic.so/apple-touch-icon.png"></Card>
                ...
                <Card color="bg-gradient-6" title="Epic Jobs" description="Epic Jobs helps you find job opportunities and helps you learn more about the people behind them via curated tweets, video introductions, interviews, and office tours." urllink="https://epicjobs.co/" logo="https://epicjobs.co/wp/wp-content/themes/epicjobs/images/favicon.png"></Card>
